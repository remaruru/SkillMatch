...
import { updateProfile, createInternship, getMyInternships, getInternshipApplicants, updateApplicationStatus, getApplicationHistory } from '../controllers/employerController.js';
